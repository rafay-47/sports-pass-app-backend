...
class UpdateEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'location_type' => 'sometimes|required|in:club,custom',
            'custom_address' => 'nullable|string|max:255',
            'custom_city' => 'nullable|string|max:100',
            'custom_state' => 'nullable|string|max:100',
            'event_date' => 'sometimes|required|date',
            'event_time' => 'sometimes|required|date_format:Y-m-d H:i:s',
            'end_date' => 'nullable|date|after_or_equal:event_date',
            'end_time' => 'nullable|date_format:Y-m-d H:i:s',
            'type' => 'sometimes|required|in:tournament,workshop,class,competition',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            // Only validate location if location_type is being updated

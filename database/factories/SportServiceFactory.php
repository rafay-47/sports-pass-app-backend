    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'icon' => $this->faker->randomElement([
                'https://placehold.co/64x64/blue/white/png?text=PT',
                'https://placehold.co/64x64/green/white/png?text=GT',
                'https://placehold.co/64x64/orange/white/png?text=ER',
                'https://placehold.co/64x64/purple/white/png?text=CB',
                'https://placehold.co/64x64/red/white/png?text=CS',
                'https://placehold.co/64x64/yellow/white/png?text=FA',
                'https://placehold.co/64x64/pink/white/png?text=NC',
                'https://placehold.co/64x64/cyan/white/png?text=RS',
            ]),
